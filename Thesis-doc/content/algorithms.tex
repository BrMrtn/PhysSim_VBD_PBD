...
This is the form used for the core comparison: no velocity damping and no
collision handling, a single distance-constraint family, and a fixed iteration
count. \autoref{alg:XPBDCore} states it; the full implemented version, with
damping and self-collision, is in \autoref{sec:AppXPBD}.
...
As with XPBD, the form below is the core-comparison version: no damping, no
collisions, and a fixed iteration count in place of the convergence early-out.
\autoref{alg:VBDCore} states it; the full implemented version, with adaptive
initialisation, line search, Chebyshev acceleration, damping and self-collision,
